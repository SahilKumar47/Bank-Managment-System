			...
			<div class="card mb-4">
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="col-md-12">
							<h2
								class="pt-3 pb-4 text-center font-bold font-up deep-purple-text my-color">Users</h2>
						...
						<tbody>
							<c:forEach var="user" items="${Users}">
								<tr class="table-warning">
									...
									<td>${user.salary}</td>
									<td><a
										href="deleteUser?id=<c:out value="${user.userId}"/>"><button
												type="button" class="btn btn-outline-danger btn-sm my-color">delete</button></a></td>
									<td><a
										href="updateUser?id=<c:out value="${user.userId}"/>"><button
