		...
		<tbody>
			...
			<c:forEach var="transactionHistory" items="${TransactionHistory}">
				<tr>
					...
					<td><a
						href="approveTransaction?id=<c:out value="${transactionHistory.transactionId}"/>">Approve</a></td>
					<td>
					<td><a
						href="rejectTransaction?id=<c:out value="${transactionHistory.transactionId}"/>">Reject</a></td>
					<td>
				</tr>
			</c:forEach>
