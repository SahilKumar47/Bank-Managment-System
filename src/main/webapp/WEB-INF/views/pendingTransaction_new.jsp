			...
			<div class="card mb-4">
				<div class="card-body">
					...
					<div class="row">
						<!-- Grid column -->
						<div class="col-md-12">
							<h2 class="pt-3 pb-4 text-center font-bold font-up danger-text">
					...
					<table class="table table-bordered red-border text-center">
						...
						<tbody>
							<c:forEach var="transactionHistory" items="${TransactionHistory}">
								<tr>
									<th>${transactionHistory.transactionId}</th>
									...
									<td><a
										href="approveTransaction?id=<c:out value="${transactionHistory.transactionId}"/>"><button
												type="button"
												class="btn btn-outline-success btn-sm my-color">Approve</button></a></td>
									<td><a
										href="rejectTransaction?id=<c:out value="${transactionHistory.transactionId}"/>"><button
												type="button" class="btn btn-outline-danger btn-sm my-color">Reject</button></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
